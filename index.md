...
Install the current released version of
[myownrobs](https://myownrobs.github.io/myownrobs/) from
...
2.  **Launch the Agent**: After configuration, you can launch the agent
    by calling
    [`myownrobs::myownrobs()`](https://myownrobs.github.io/myownrobs/reference/myownrobs.md)
    in the R console, or by opening the MyOwnRobs addin through the
    RStudio Addins menu:
...
[LICENSE](https://myownrobs.github.io/myownrobs/LICENSE) file for
details.
